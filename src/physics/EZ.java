...
abstract class EZElement {
   ...
   * 
   * @param d coordinate of the point to check.
   * @param e coordinate of the point to check.
   * @return true if the specified point is within this element. Otherwise returns false.
   */
  public boolean isPointInElement(double d, double e) {
    return this.getBounds().contains(d, e);
...
class EZGroup extends EZElement {
   ...
   */
  @Override public boolean isPointInElement(double x, double y) {
